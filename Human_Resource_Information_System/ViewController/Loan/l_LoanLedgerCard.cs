...
namespace Human_Resource_Information_System
{
    ...
    { thisDatabase db = new thisDatabase();
        ...
        public void disp_list(String empcode)
        {
            ...
            dt = db.QueryBySQLCode("SELECT loan_code, loan_desc,TO_CHAR(loan_transdate,'YYYY-MM-DD') AS loan_transdate, loan_location, loan_type, user_id, whs_location_code, loan_cost_center_code,loan_cost_center_name,loan_sub_cost_center,employee_no,employee_name,loan_amount,loan_deduction FROM rssys.hr_loanhdr  WHERE employee_no='" + empcode + "'ORDER BY loan_code");
        ...
        {
            RPT_RES_entry frm = new RPT_RES_entry("M105", "Empoyee Loan History");
            frm.print_employee_loan_summary((cbo_employee.SelectedValue??"").ToString(), "", "");
