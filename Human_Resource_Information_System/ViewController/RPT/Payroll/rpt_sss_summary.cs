...
{
    public partial class rpt_sss_summary : Form
    {
        ...
        private void rpt_sss_summary_Load(object sender, EventArgs e)
        {
        ...
        private void display_list()
        {
            dgvl_other_earnings.Invoke(new Action(() => {
                ...
                int i = 0;
                String query = "SELECT * FROM rssys.hr_rpt_files WHERE rpt_type = 'SSS' ORDER BY date_added";
        ...
        private void bgworker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            //System.IO.FileStream fs = new FileStream("\\\\RIGHTAPPS\\RightApps\\Eastland\\payroll_reports\\sss_summary\\" + filename, FileMode.Create);
            System.IO.FileStream fs = new FileStream(fileloc_dtr + "\\ViewController\\RPT\\Payroll\\sss_summary\\" + filename, FileMode.Create);
            ...
            paragraph.Add("SSS DEDUCTIONS REPORTS SUMMARY");
            ...
            val = "'" + code + "','" + filename + "','" + DateTime.Now.ToShortDateString() + "','SSS'";
        ...
        private void btn_print_Click(object sender, EventArgs e)
        {
            int r = -1;
            String dtr_filename = "";
            //String sys_dir = "\\\\RIGHTAPPS\\RightApps\\Eastland\\payroll_reports\\sss_summary\\";
            String sys_dir = fileloc_dtr + "\\ViewController\\RPT\\Payroll\\sss_summary\\";
            try
            {
                ...
                if (dgvl_other_earnings.Rows.Count > 1)
                {
                    ...
                    try
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            ...
                            String query = "DELETE FROM rssys.hr_rpt_files WHERE rpt_id = '" + rpt_id + "' AND rpt_type = 'SSS'";
