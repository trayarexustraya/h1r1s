...
namespace Human_Resource_Information_System
{
    public partial class RPT_RES_entry2 : Form
    {
        ...
        public RPT_RES_entry2(String _rpt_code)
        {
            ...
            else if (rpt_code == "P201")
            {
                this.Text = "Witholding Tax Summary";
            ...
            else if (rpt_code == "P204")
            {
                this.Text = "PAG-IBIG Contribution Summary";
            ...
            else if (rpt_code == "P205")
            {
                this.Text = "13th Month Pay Summary";

                lbl_1.Text = "Financial Year";
                lbl_2.Text = "Month";
                lbl_3.Text = "Employment Status";
                lbl_1.Show(); lbl_2.Show(); lbl_2to.Show(); lbl_3.Show();
                ...
                gc.load_emp_stat(cbo_3);
                cbo_3.SelectedValue = "REG";
                cbo_3.Show();

                groupBox1.Height = 120;
                this.Height = 247;
            }
            else if (rpt_code == "P206")
            {
                this.Text = "Gross Pay Summary";
            ...
            else if (rpt_code == "P208")
            {
                this.Text = "Cummulative Payroll Report";

                lbl_1.Text = "Financial Yr";
                lbl_2.Text = "Payroll Period";
                lbl_3.Text = "Department";
                lbl_1.Show(); lbl_2.Show(); lbl_2to.Show(); lbl_3.Show(); lbl_3to.Show(); 
                ...
                load_department(cbo_3frm); load_department(cbo_3to);
                cbo_3frm.Show(); cbo_3to.Show();

                groupBox1.Height = 120;
                this.Height = 247;
            }
            else if (rpt_code == "P207")
            {
                this.Text = "Leave Status Report";

                lbl_1.Text = "Financial Yr";
                lbl_2.Text = "Employee From";
                lbl_3.Text = "           To";
                ...
                load_employee(cbo_2); load_employee(cbo_3);
                cbo_2.Show(); cbo_3.Show();

                groupBox1.Height = 120;
                this.Height = 247;
            }
            else if (rpt_code == "P209")
            {
                this.Text = "Leave Balance Report";

                lbl_1.Text = "Financial Yr";
                lbl_2.Text = "Department From";
                lbl_3.Text = "           To";
                lbl_1.Show(); lbl_2.Show();  lbl_3.Show();
                ...
                load_department(cbo_2); load_department(cbo_3);
                cbo_2.Show(); cbo_3.Show();
            ...
            else if (rpt_code == "M105")
            {
                this.Text = "Employee Loan Summary";

                lbl_1.Text = "Employee";
                lbl_2.Text = "Transaction Date";
                lbl_1.Show(); lbl_2to.Show(); lbl_2.Show(); 

                load_employee(cbo_1);
                cbo_1.Show();

                dtp_2frm.Value = DateTime.Parse(dtp_2frm.Value.ToString("yyyy-MM-01"));
                dtp_2frm.Show(); dtp_2to.Show();
        ...
        private void btn_proceed_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Are you sure you want to proceed?", "", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                {
                    RPT_RES_entry frm = new RPT_RES_entry(rpt_code, this.Text);
                    frm.print_witholdingtax_summary(cbo_1.Text, cbo_2frm.Text, cbo_2to.Text, cbo_3.Text, (cbo_3.SelectedValue ?? "").ToString(), cbo_4l.Text, (cbo_4l.SelectedValue ?? "").ToString());
                ...
                {
                    RPT_RES_entry frm = new RPT_RES_entry(rpt_code, this.Text);
                    frm.print_pagibig_contribution_summary(cbo_1.Text, cbo_2frm.Text, cbo_2to.Text, cbo_3.Text, (cbo_3.SelectedValue ?? "").ToString(), cbo_4l.Text, (cbo_4l.SelectedValue ?? "").ToString());
                ...
                {
                    RPT_RES_entry frm = new RPT_RES_entry(rpt_code, this.Text);
                    frm.print_13monthpay_summary(cbo_1.Text, cbo_2frm.Text, cbo_2to.Text, cbo_3.Text, (cbo_3.SelectedValue ?? "").ToString());
                ...
                {
                    RPT_RES_entry frm = new RPT_RES_entry(rpt_code, this.Text);
                    frm.print_grosspay_summary(cbo_1.Text, cbo_2frm.Text, cbo_2to.Text, cbo_3.Text, (cbo_3.SelectedValue ?? "").ToString());
                ...
                {
                    RPT_RES_entry frm = new RPT_RES_entry(rpt_code, this.Text);
                    frm.print_leave_status(cbo_1.Text, cbo_2.Text, (cbo_2.SelectedValue ?? "").ToString(), cbo_3.Text, (cbo_3.SelectedValue ?? "").ToString());
                    frm.ShowDialog();
                }
                else if (rpt_code == "P208")
                {
                    RPT_RES_entry frm = new RPT_RES_entry(rpt_code, this.Text);
                    frm.print_cummulative_payroll(cbo_1.Text, cbo_2frm.Text, cbo_2to.Text, cbo_3frm.Text, (cbo_3frm.SelectedValue ?? "").ToString(), cbo_3to.Text, (cbo_3to.SelectedValue ?? "").ToString());
                    frm.ShowDialog();
                }
                else if (rpt_code == "P209")
                {
                    RPT_RES_entry frm = new RPT_RES_entry(rpt_code, this.Text);
                    frm.print_leave_balance(cbo_1.Text, cbo_2.Text, (cbo_2.SelectedValue ?? "").ToString(), cbo_3.Text, (cbo_3.SelectedValue ?? "").ToString());
                    frm.ShowDialog();
                }
                ...
                {
                    RPT_RES_entry frm = new RPT_RES_entry(rpt_code, this.Text);
                    frm.print_employee_loan_summary((cbo_1.SelectedValue ?? "").ToString(), dtp_2frm.Value.ToString("yyyy-MM-dd"), dtp_2to.Value.ToString("yyyy-MM-dd"));
                    frm.ShowDialog();
                }
