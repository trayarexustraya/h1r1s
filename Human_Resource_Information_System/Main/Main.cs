...
namespace Human_Resource_Information_System
{
    public partial class Main : Form
    {
        ...
        {
            rpt_other_earnings rpt_oe = new rpt_other_earnings();
        ...
        {
            rpt_print_dtr rpt_dtr = new rpt_print_dtr();
            closechild();
            btn_color_reset();
        ...
        private void employeeSummaryToolStripMenuItem_Click(object sender, EventArgs e)
        {
