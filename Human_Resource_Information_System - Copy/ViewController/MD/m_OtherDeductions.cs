...
{
    public partial class m_OtherDeductions : Form
    {
        ...
        public m_OtherDeductions()
        {
            InitializeComponent();
        }

        private void m_OtherDeductions_Load(object sender, EventArgs e)
        {
            disp_list();
        }
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            String table = "hr_other_deductions";
        ...
        private void disp_list()
        {
            ...
            DataTable dt = db.QueryBySQLCode("SELECT * from rssys.hr_other_deductions WHERE COALESCE(cancel,cancel,'')<>'Y'");
        ...
        private void btn_upditem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("No deduction selected.");
                }
            }
            catch
            {
        ...
        private void btn_delitem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dgv_list.Rows.Count > 1 && !String.IsNullOrEmpty(code))
                {
                    if (MessageBox.Show("Are you sure you want to cancel this deduction?", "", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        try
                        {
                            db.UpdateOnTable("hr_other_deductions", "cancel='Y'", "code=" + db.str_E(code) + "");
        ...
        {
            RPT_RES_entry frm = new RPT_RES_entry("MD13", "Pag-ibig Brackets");
