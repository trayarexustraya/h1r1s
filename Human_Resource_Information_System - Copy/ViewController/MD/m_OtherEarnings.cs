...
{
    public partial class m_OtherEarnings : Form
    {
        ...
        public m_OtherEarnings()
        {
            InitializeComponent();
        }


        private void m_OtherEarnings_Load(object sender, EventArgs e)
        {
            disp_list();
        }
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            String table = "hr_other_earnings";
        ...
        private void disp_list()
        {
            ...
            DataTable dt = db.QueryBySQLCode("SELECT * from rssys.hr_other_earnings WHERE COALESCE(cancel,cancel,'')<>'Y'");
        ...
        private void btn_upditem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("No earning selected.");
                }
            }
            catch
            {
        ...
        private void btn_delitem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dgv_list.Rows.Count > 1 && !String.IsNullOrEmpty(code))
                {
                    if (MessageBox.Show("Are you sure you want to cancel this earning?", "", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        try
                        {
                            db.UpdateOnTable("hr_other_earnings", "cancel='Y'", "code=" + db.str_E(code) + "");
        ...
        {
            RPT_RES_entry frm = new RPT_RES_entry("MD12", "Pag-ibig Brackets");
