...
{
    public partial class p_Payslips : Form
    {
        ...
        {
            p_PayslipsEntry frm = new p_PayslipsEntry(this, "", true);
            frm.ShowDialog();
            disp_list();
        }
        ...
        private void btn_upd_Click(object sender, EventArgs e)
        {
            ...
            if (dgv_list.Rows.Count > 1)
            {
                ...
                p_PayslipsEntry frm = new p_PayslipsEntry(this,code, false);
                frm.ShowDialog();
                disp_list();
            }
            else {
        ...
        public void disp_list()
        {
            ...
            dt = db.QueryBySQLCode("SELECT r.payslip_code, r.payroll_period_code, r.dept_frm, r.dept_until, r.employee, r.report_type, r.payroll_period_desc, e.lastname || ',' || e.firstname  AS empname FROM rssys.hr_payslip r LEFT JOIN rssys.hr_employee e ON r.employee=e.empid ORDER BY payslip_code");
            ...
            for (int r = 0; r < dt.Rows.Count; r++)
            {
                ...
                row.Cells["dgvl_payrollreg_code"].Value = dt.Rows[r]["payslip_code"].ToString();
